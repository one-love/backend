...
@ns_cluster.route('/<cluster_id>/application/<application_name>', endpoint='api/cluster/application')
...
@ns_cluster.route('/<cluster_id>/application/<application_name>/provision', endpoint='api/cluster/application/provision')
